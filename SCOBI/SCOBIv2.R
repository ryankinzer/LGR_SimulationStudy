...
SCOBIv2 <- function(adultData = NULL, windowData = NULL, Run = "output", RTYPE = "W", Primary = "GenStock",
                  Secondary = NA, SizeCut = NULL, alph = 0.1, B = 5000, writeThetas = FALSE, writeOutput = TRUE,
                  pbtExpand = FALSE, pbtRates = NULL, print = FALSE)
{
  # THIS IS SCOBIv2.0
...
return(list(Rearing = Rearing, PrimeResults = PrimeResults))
