...
# save results
save(res, file = 'SimulationFits/Sim_TrapShutdown_WinErr_high.rda')
# save(sim_list, obs_list, mod_list, file = 'SimulationFits/Sim_TrapShutdown_WinErr_high_other.rda')